  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-xs-12">
        ...
        <h3>Provincia</h3>
        <select id="provincia" name="provincia" autocomplete="off" class="select-css" ><br/>
          <option value="1">Modena (+1h)</option>
          <option value="2">Bologna (+2h)</option>
          <option value="1">Reggio Emilia (+1h)</option>
          <option value="3">Milano (+3h)</option>
        </select><br/><br/>
